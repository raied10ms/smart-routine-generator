...
function renderDiagnosis(assessment: Assessment): string {
  ...
  const faceSvg: Record<AssessmentStatus, string> = {
    ...
    syllabus_nai: `<svg width="11" height="11" viewBox="0 0 16 16" fill="none" style="vertical-align:middle;margin-right:2px"><path d="M7.5 12 L5 4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M8.5 12 L11 4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M5 12 Q8 14 11 12" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>`,
  };
